...
const foundDirname =
  !regularDirname &&
  findSync(process.cwd(), ["lib/prisma", "prisma"], ["d"], ["d"], 1)[0]
...
const config = {
  generator: {
    ...
    output: {
      value: "/Users/lin/Documents/Projects/near-journey/lib/prisma",
      fromEnvVar: null,
    },
    config: {
      engineType: "library",
...
path.join(process.cwd(), "lib/prisma/libquery_engine-darwin.dylib.node")
